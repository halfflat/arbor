...
\usepackage[scale=.95]{cabin}

\newfontfamily\dispfamily{Cabin}
...
\end{equation}
for some $\mu$. This has solutions in terms of Bessel functions: if $C_\nu$
...
\begin{equation}
    \label{eq:besg}
    x^2 g''(x) + x g'(x) + \frac{\alpha^2}{4} x g(x) = 0.
\end{equation}
