...
The derivation of the one-dimensional conservation equation \eq{eq:cable_balance} is based on the assumption that the intracellular potential (i.e. inside the cell) does not vary radially.
...
The electrode currents are modelled as discrete current sources,
\begin{equation}
